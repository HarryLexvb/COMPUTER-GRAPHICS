...
int main(int agrc, char* argv[]) {
    ...
    std::cout << "Cledy Becerra Siipiran" << std::endl;
    ...
    std::cout << "Presione la tecla 'W' para el movmiento L en el sentido antihorario" << std::endl;
    std::cout << "Presione la tecla 'E' para el movmiento U en el sentido horario" << std::endl;
    std::cout << "Presione la tecla 'R' para el movmiento D en el sentido antihorario" << std::endl;
    std::cout << "Presione la tecla 'T' para el movmiento F en el sentido horario" << std::endl;
    std::cout << "Presione la tecla 'Y' para el movmiento B en el sentido antihorario" << std::endl;
    ...
    std::cout << "Presione la tecla '2' para realizar la animacion de la respiracion (esta puede ser presionada des pues de presiona la  tecla 1 o ambos a la vez)" << std::endl;    
    std::cout << "Presione la tecla '3' para realizar la animacion 'Expansion' del cubo" << std::endl;
    

    string route = argv[0];
    rutaImagen = "D:/LabCompiler_CG/glfw-master/OwnProjects/cubeMassa/image/colors.jpg";
    init();
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        if (Animation == true){
            ...
            // mover el cubo durante 3 segundos
        if(incremento < 5.0f){ // :3
